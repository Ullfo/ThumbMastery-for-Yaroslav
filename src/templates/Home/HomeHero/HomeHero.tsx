      ...
      <section className="relative flex flex-col items-center text-center gap-8 mt-20 mb-[100px]">
         ...
         <h1 className="pb-1 max-w-[1090px] text-h1 font-bold">
            ...
            <span className="relative inline-block ">
               Thumbnails
               <span className="absolute bottom-0 left-0 w-full h-2 bg-gradient--3 bg-[length:200%_200%] animate-gradientShift"></span>
            </span>
         ...
         >
            <ul className="flex gap-8 py-5 pl-8">
               {data.map((item) => (
                  <Link key={item.name} href="/" className="flex gap-2">
